...
from model.FViT import build_backbone
...
# python train.py --eval True --model FViT --datasets_path E:/Datasets/ImageNet --resume E:/Codes/FViT-main/save_path/FViT_Large.pth
def get_args_parser():
    parsers = argparse.ArgumentParser('training and evaluation script', add_help=False)

    # important parameters
    parsers.add_argument('--save_path', default='/home/ubuntu/Codes/FViT-main/save_path/', help='path where to save, empty for no saving')
